...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-light shadow" style="height:60px;">
            ...
            <a class="navbar-brand ps-3" href="<?php echo route('mainhome') ?>" style="color:black;"><h3>ADMIN<span style="color:green;"> .</span></h3></a>
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4" >
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?php echo route('cadminprofilelist')?>"><i class='bx bxs-user-account'></i> Settings</a></li>
...
<?php /**PATH D:\Laravel\Project1\resources\views/admin/adminnavbar.blade.php ENDPATH**/ ?>