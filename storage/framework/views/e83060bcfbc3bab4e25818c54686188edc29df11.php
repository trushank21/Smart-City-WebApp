...
<?php echo csrf_field(); ?>
    <div class="container">
    <h1 class="text-center mt-3 animate__animated animate__bounceInDown" style="color:darkgreen;">PROJECT LIST<i class='bx bx-cog bx' ></i></h1>
    <div class="row mb-2">
            ...
            <div class="col-md-12 p-4 mb-4" >
               ...
               <th>ID</th>
                ...
                <tbody>
                    ...
                    <tr>
                    <td class="text-center"><a class="btn btn-success" href="/cprojectsearch/<?php echo e($pro['id']); ?>" style="text-decoration: none;">Update</a></td>
                    <td class="text-center"><a class="btn btn-danger" href="/cprojectdelete/<?php echo e($pro['id']); ?>" style="text-decoration: none;">Delete</a></td>
               ...
               <a class="btn btn-primary" style="text-decoration:none;width:150px;margin-left:10px;" href="<?php echo route('projectinsert') ?>">New</a>
               </td>   
            </tr>
               </table>
               </div>
