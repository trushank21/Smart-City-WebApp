...
<form action="/ccollegeinsert" method="post" onSubmit="return formvalid()" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
<div class="container">
        <div class="row  mt-3">
        <h1 class="text-center" style="color:darkgreen;">COLLEGE INSERT</h1>
            <div class="col-md-3"></div>
            <div class="col-md-6 p-4 mb-4  bg-light shadow" >
            
                <div class="form-group">
                    <label>Collegename</label>
                    <input type="text" class="form-control" name="collegename" value="">
                    <label></label>
                </div>
                <div class="form-group">
                    <label>Address</label>
                ...
                <!-- <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="collegetype" value="">
                    <label></label>
                </div>

                <div class="form-group">
                    <label>trustname</label>
                    <input type="text" class="form-control" name="trustname" value="">
                    <label></label>
                </div> -->
                ...
                <!-- <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="courselist" value="">
                    <label></label>
                </div>
...
<?php echo $__env->make('admin\layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Project1\resources\views/admin/collegeinsert.blade.php ENDPATH**/ ?>