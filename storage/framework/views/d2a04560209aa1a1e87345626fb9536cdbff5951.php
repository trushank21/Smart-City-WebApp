...
<h1 class="text-center text-success mt-3">Payment Insert</h1>
        ...
        <div class='container'>    
            ...
            <div class="col-md-3"></div>  
               <div class="col-md-6 bg-light shadow p-4">
                    ...
                    <div class="form-group">
                        <label>TaxID</label>
                        <input type="text" class="form-control" name="taxid" value="<?php echo e(Session::get('taxid')); ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Amount</label>
                        <input type="text" class="form-control" name="amount" value="<?php echo e(Session::get('amount')); ?>" readOnly>
                    </div>
                    <div class="form-group">
