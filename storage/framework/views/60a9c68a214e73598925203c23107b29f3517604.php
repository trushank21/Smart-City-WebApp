...
<form action="/ccomplainupdate" method="post">
 ...
 <div class="container">
    ...
    <h1 class="text-center" style="color:darkgreen;">COMPLAIN UPDATE</h1>
        ...
        <input type="text" class="form-control" name="id" value="<?php echo e($complain['complainid']); ?>" readonly>
        </div>
        <div class="form-group">
        <label>ComplainDate</label>
        <input type="text" class="form-control" name="projectname" value="<?php echo e($complain['complaindate']); ?>" readonly>
        </div>
        <div class="form-group">
        <label>Citizenid</label>
        <input type="text" class="form-control" name="projecttype" value="<?php echo e($complain['citizenid']); ?>" readonly >
        </div>
        <div class="form-group">
        <label>Complain</label>
        <textarea class="form-control" name="complain" rows='5' cols='30' value="" readonly></textarea>
        <label></label>
        </div>
        <div class="form-group">
