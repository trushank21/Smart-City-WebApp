...
<?php echo csrf_field(); ?>
    <div class="container">
    <h1 class="text-center mt-3" style="color:darkgreen;">Tax Show<i class='bx bxs-credit-card'></i></h1>
               ...
               <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a class="btn btn-danger  " href="<?php echo route('paymentinsert') ?>">Pay Tax</a></td>
                    </tr>
