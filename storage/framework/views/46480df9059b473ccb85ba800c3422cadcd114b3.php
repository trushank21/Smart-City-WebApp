...
<form action="/ccontactus" method="post">
    <?php echo csrf_field(); ?>
<div class="row  mt-3">
        <h1 class="text-center" style="color:darkgreen;">PROFILE</h1>
            ...
            <div class="col-md-4 p-4 mb-4  bg-dark"  style="border-left: 5px solid rgb(50, 177, 84);border-left-style:dashed;">
                ...
                <div class="form-group">
                    <label style="color: white;">ContactDate</label>
                    <input type="date" class="form-control" name="Contactdate" value="">
                </div>
                <div class="form-group">
                    <label style="color: white;">Contactno</label>
                    <input type="number" class="form-control" name="Contactno" value="">
                </div>
                <div class="form-group">
...
<?php echo $__env->make('main\layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Project1\resources\views/main/contactus.blade.php ENDPATH**/ ?>